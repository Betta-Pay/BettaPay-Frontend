...
/**
 * Interactive admin chrome (sidebar, drawer, topbar, command palette).
 *
 * Only rendered by `app/(admin)/layout.tsx` after the server has confirmed an
 * admin session, so non-admins never receive this chunk (issue #776).
 */
