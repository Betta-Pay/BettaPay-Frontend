...
export const metadata: Metadata = {
  ...
  description: 'Step-by-step guides to integrate BettaPay payment processing into your platform.',
};
    ...
    <div className="min-h-screen bg-card text-foreground flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-6">
        <div className="text-center max-w-md">
          ...
          <h1 className="text-3xl font-bold tracking-tight mb-3">Integration Guides</h1>
          <p className="text-muted-foreground leading-relaxed mb-2">
            Step-by-step walkthroughs for React, Next.js, Node.js, and mobile platforms.
          </p>
