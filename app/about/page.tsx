...
export const metadata: Metadata = {
  ...
  description: 'Building the next-generation payment infrastructure for African merchants.',
};
    ...
    <div className="min-h-screen bg-card text-foreground flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-6">
        <div className="text-center max-w-md">
          ...
          <h1 className="text-3xl font-bold tracking-tight mb-3">About BettaPay</h1>
          <p className="text-muted-foreground leading-relaxed mb-2">
            We are building non-custodial payment infrastructure for African merchants, powered by the Stellar network.
          </p>
